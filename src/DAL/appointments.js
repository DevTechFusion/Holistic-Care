...
export const getAppointments = (page = 1, per_page = 15, start_date = "", end_date = "", doctor_id = "", agent_id = "", department_id = "", procedure_id = "", patient_name = "", contact_number = "",status_id = "", remarks_1_id = "", remarks_2_id = "", payment_method = "", order_by = "created_at", order_direction = "desc") => {
  return invokeApi({
